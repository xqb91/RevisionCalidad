...
<body id="page-top">
                  ...
                  <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      ...
                      <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                        <button type="button" class="btn btn-success" id="btnAprobarApelacion"><i class="fas fa-check"></i> Aprobar Apelación</button>
                        <button type="button" class="btn btn-danger" id="btnRechazarApelacion"><i class="fas fa-times"></i> Rechazar Apelación</button>
                      </div>
                    </div>
                  </nav>
  ...
  <script src="transaction/opciones.js"></script>
